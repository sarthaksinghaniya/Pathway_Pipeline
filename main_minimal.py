"""
Minimal end-to-end pipeline for novel-backstory consistency classification.
...
Uses minimal dependencies - only basic Python libraries.
"""
...
from src.vector_store_minimal import MinimalVectorStore
from src.retrieval_minimal import MinimalBackstoryRetriever
from src.reasoning_minimal import MinimalConsistencyReasoner
from src.aggregation import ConsistencyAggregator


class MinimalConsistencyPipeline:
    """Minimal end-to-end pipeline for backstory-novel consistency classification."""
    ...
    def __init__(self, novels_dir: str):
        ...
        self.retriever = MinimalBackstoryRetriever(self.vector_store)
        self.reasoner = MinimalConsistencyReasoner()
    ...
    def setup_vector_store(self):
        ...
        self.chunks_df = self.vector_store.create_embeddings_dataframe(chunks)
...
def main():
    ...
    pipeline = MinimalConsistencyPipeline(args.novels_dir)
