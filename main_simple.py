"""
Simplified end-to-end pipeline for novel-backstory consistency classification.
...
Uses simplified implementations without Pathway dependency.
"""
...
from src.vector_store_simple import SimpleVectorStore
from src.retrieval_simple import SimpleBackstoryRetriever
from src.reasoning import ConsistencyReasoner
from src.aggregation import ConsistencyAggregator


class SimpleConsistencyPipeline:
    """Simplified end-to-end pipeline for backstory-novel consistency classification."""
    ...
    def __init__(self, novels_dir: str, model_name: str = "all-MiniLM-L6-v2"):
        ...
        self.vector_store = SimpleVectorStore(model_name)
        self.retriever = SimpleBackstoryRetriever(self.vector_store)
...
def main():
    ...
    pipeline = SimpleConsistencyPipeline(args.novels_dir, args.model)
