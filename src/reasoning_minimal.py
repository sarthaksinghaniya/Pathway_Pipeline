"""
Minimal reasoning module to evaluate SUPPORT/CONTRADICT/NEUTRAL relationships.
Uses only basic libraries without sentence transformers.
"""
...
class MinimalConsistencyReasoner:
    ...
    def evaluate_chunk_consistency(self, backstory: str, chunk: Dict[str, Any]) -> Dict[str, Any]:
        ...
        semantic_sim = self.calculate_jaccard_similarity(backstory, chunk_text)
