"""
Minimal retrieval module using the minimal vector store.
"""
...
class MinimalBackstoryRetriever:
    """Handles retrieval of relevant novel chunks for given backstories."""
    
    def __init__(self, vector_store: MinimalVectorStore, top_k: int = 10, similarity_threshold: float = 0.1):
        """
        Initialize the retriever.
        
        Args:
            vector_store: Initialized minimal vector store
